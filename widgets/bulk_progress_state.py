...
class BulkProgressTracker:
    ...
    def workflow_started(
        ...
        *,
        ...
        self.counts.current_row_number = current_row_number
        self.counts.current_workflow_number = workflow_number
    ...
    def eval_started(
        ...
        *,
        ...
        response.eval_progress = BulkEvalProgress(
            current=current,
            total=total,
...
def is_bulk_progress_complete(progress: BulkProgressCounts) -> bool:
    return 0 < progress.total_unit_runs <= progress.completed_unit_runs


def build_bulk_progress(
    *,
    counts: BulkProgressCounts,
    page_cls: type[BasePage],
    sr: SavedRun,
    pr,
    request_body: dict,
    ...
    if current_workflow_completed:
        ...
        bulk_progress.last_completed_workflow_title = (
            previous_progress.last_completed_workflow_title
        )
        bulk_progress.last_completed_workflow_url = (
            previous_progress.last_completed_workflow_url
        )
        bulk_progress.last_completed_run_time_seconds = (
            previous_progress.last_completed_run_time_seconds
        )
        bulk_progress.last_completed_credits = previous_progress.last_completed_credits

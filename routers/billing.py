...
available_subscriptions = {
    "addon": {
        "display": {
            ...
            "description": "Buy a one-time top up of 100 Credits for $1. 1000 credits is good for ~200 runs, depending on which <a href=\"https://gooey.ai/explore/\">workflows</a> you call.",
        },
        "stripe": {
            "price_data": {
                "currency": "usd",

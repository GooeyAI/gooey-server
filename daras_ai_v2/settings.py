...
GOOGLE_MAPS_API_KEY_HOSTNAMES = config(
    "GOOGLE_MAPS_API_KEY_HOSTNAMES",
    default=",".join(["gooey.ai", "127.0.0.1"]),
    cast=Csv(),
)
...
# AIModelSpec names the Model API serves; empty serves none
MODEL_API_ALLOWED_MODELS = config("MODEL_API_ALLOWED_MODELS", cast=Csv(), default="")
...
STRIPE_ITEM_SEAT_TYPE_METADATA_FIELD: str = "seat_type"
...
INTRON_API_KEY = config("INTRON_API_KEY", "")
...
LANGFUSE_PUBLIC_KEY = config("LANGFUSE_PUBLIC_KEY", None)
LANGFUSE_SECRET_KEY = config("LANGFUSE_SECRET_KEY", None)
LANGFUSE_BASE_URL = config("LANGFUSE_BASE_URL", None)

ECO_COST_METHODOLOGY_URL = config(
    "ECO_COST_METHODOLOGY_URL",
    "https://github.com/GooeyAI/ecocost/blob/main/METHODOLOGY.md",
)

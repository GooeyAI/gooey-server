...
ADDON_AMOUNT_CHOICES = config(
    "ADDON_AMOUNT_CHOICES", cast=Csv(int), default="10,30,50,100,300,500"
)
AUTO_RECHARGE_MAX_AMOUNT = config(
    "AUTO_RECHARGE_MAX_AMOUNT", 1000, cast=int
)  # in dollars
AUTO_RECHARGE_COOLDOWN_SECONDS = config(
    "AUTO_RECHARGE_COOLDOWN_SECONDS", cast=int, default="60"
)  # 1 minute

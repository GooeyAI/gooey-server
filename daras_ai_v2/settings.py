...
STRIPE_WEBHOOKS_KEY = config("STRIPE_WEBHOOKS_KEY")
...
CREDITS_TO_DEDUCT_PER_RUN = config("CREDITS_TO_DEDUCT_PER_RUN", default=5)
CREDITS_TO_ADD_NEW_USER_ANONYMOUS = 25
CREDITS_TO_ADD_NEW_USER_SIGNED_IN = 1000

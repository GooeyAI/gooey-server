...
WORKFLOW_ICON_PROMPT_GENERATOR_EXAMPLE_ID = config(
    "WORKFLOW_ICON_GENERATOR_EXAMPLE_ID", "1mq4qnh1c2ck"
)

WORKFLOW_ICON_IMAGE_GENERATOR_EXAMPLE_ID = config(
    "WORKFLOW_ICON_IMAGE_GENERATOR_EXAMPLE_ID", "180hskjqmfyy"
)

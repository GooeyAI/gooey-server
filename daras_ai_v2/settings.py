...
BOT_GENERATOR_EXAMPLE_ID = config("BOT_GENERATOR_EXAMPLE_ID", "gsvm4rw9tus0")
...
OUT_OF_CREDITS_EMAIL_ENABLED = config("OUT_OF_CREDITS_EMAIL_ENABLED", True, cast=bool)
OUT_OF_CREDITS_EMAIL_DAYS = config("OUT_OF_CREDITS_EMAIL_DAYS", 1, cast=int)

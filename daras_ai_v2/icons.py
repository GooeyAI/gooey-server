...
erase = '<i class="fa-regular fa-eraser"></i>'
...
external_link = '<i class="fa-solid fa-arrow-up-right-from-square"></i>'
...
explore = '<i class="fa-regular fa-magnifying-glass"></i>'
...
chevron_down = '<i class="fa-sharp-duotone fa-solid fa-sm fa-chevron-down"></i>'

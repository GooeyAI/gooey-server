...
class EcoRegionProps(BaseModel):
    ...
    country_code: str  # ISO 3166-1 alpha-2, drives the flag
    label: str  # the country: "Norway", "United States"
...
class EcoLabelProps(BaseModel):
    ...
    # inputs behind the confidence label, as ecocost reason codes
    reasons: list[str] = []
    methodology_url: str

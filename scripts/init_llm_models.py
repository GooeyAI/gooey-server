...
def run():
    ...
    o1_preview = AIModelSpec.objects.create(
        category=AIModelSpec.Categories.llm,
        name="o1_preview",
        label="o1-preview • openai [Redirects to o3]",
    ...
    llama3_3_70b = AIModelSpec.objects.create(
        category=AIModelSpec.Categories.llm,
        name="llama3_3_70b",
        label="Llama 3.3 70B • Meta AI [Redirects to Llama 4 Maverick]",
    ...
    llama3_2_90b_vision = AIModelSpec.objects.create(
        ...
        label="Llama 3.2 90B + Vision • Meta AI [Redirects to Llama 4 Maverick]",
    ...
    llama3_2_11b_vision = AIModelSpec.objects.create(
        ...
        label="Llama 3.2 11B + Vision • Meta AI [Redirects to Llama 4 Maverick]",
    ...
    llama3_2_3b = AIModelSpec.objects.create(
        category=AIModelSpec.Categories.llm,
        name="llama3_2_3b",
        label="Llama 3.2 3B • Meta AI [Redirects to Llama 4 Maverick]",
    ...
    llama3_2_1b = AIModelSpec.objects.create(
        category=AIModelSpec.Categories.llm,
        name="llama3_2_1b",
        label="Llama 3.2 1B • Meta AI [Redirects to Llama 4 Maverick]",
    ...
    llama3_1_405b = AIModelSpec.objects.create(
        category=AIModelSpec.Categories.llm,
        name="llama3_1_405b",
        label="Llama 3.1 405B • Meta AI [Redirects to Llama 4 Maverick]",
    ...
    llama3_1_70b = AIModelSpec.objects.create(
        category=AIModelSpec.Categories.llm,
        name="llama3_1_70b",
        label="Llama 3.1 70B • Meta AI [Redirects to Llama 4 Maverick]",
    ...
    llama3_1_8b = AIModelSpec.objects.create(
        category=AIModelSpec.Categories.llm,
        name="llama3_1_8b",
        label="Llama 3.1 8B • Meta AI [Redirects to Llama 4 Maverick]",
    ...
    llama3_70b = AIModelSpec.objects.create(
        category=AIModelSpec.Categories.llm,
        name="llama3_70b",
        label="Llama 3 70B • Meta AI [Redirects to Llama 4 Maverick]",
    ...
    llama3_8b = AIModelSpec.objects.create(
        category=AIModelSpec.Categories.llm,
        name="llama3_8b",
        label="Llama 3 8B • Meta AI [Redirects to Llama 4 Maverick]",

        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                ...
                choices=[
                    ...
                    (
                        "deepseek_r1",
                        "DeepSeek R1 [Redirects to DeepSeek V3.2 • DeepSeek]",
                    ),
                    (
                        "deepseek_v3p1",
                        "DeepSeek V3.1 • DeepSeek [Redirects to DeepSeek V3.2 • DeepSeek]",
                    ),
                    ("deepseek_v3p2", "DeepSeek V3.2 • DeepSeek"),
                    ...
                    ("gemini_live", "Gemini Live (Voice Only) • Google"),
                    (
                        "palm2_text",
                    ...
                    (
                        "claude_4_sonnet",
                        "Claude 4 Sonnet • Anthropic [Redirects to Claude 4.5 Sonnet • Anthropic]",
                    ),
                    (
                        "claude_4_opus",
                        "Claude 4 Opus • Anthropic [Redirects to Claude 4.1 Opus • Anthropic]",
                    ),
                    (
                        "claude_3_7_sonnet",
                        "Claude 3.7 Sonnet • Anthropic [Redirects to Claude 4.5 Sonnet • Anthropic]",
                    ),
                    (
                        "claude_3_5_sonnet",
                        "Claude 3.5 Sonnet • Anthropic [Redirects to Claude 4.5 Sonnet • Anthropic]",
                    ),
                    (
                        "claude_3_opus",
                        "Claude 3 Opus • Anthropic [Redirects to Claude 4.5 Sonnet • Anthropic]",
                    ),
                    (
                        "claude_3_sonnet",
                        "Claude 3 Sonnet • Anthropic [Redirects to Claude 4.5 Sonnet • Anthropic]",
                    ),
                    (
                        "claude_3_haiku",
                        "Claude 3 Haiku • Anthropic [Redirects to Claude 4.5 Sonnet • Anthropic]",
                    ),
                    (
                        "afrollama_v1",

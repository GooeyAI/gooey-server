# Generated by Django 5.1.3 on 2025-06-09 10:48
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("usage_costs", "0030_alter_modelpricing_model_name_and_more"),
    ]
    ...
    operations = [
        migrations.AlterField(
            ...
            field=models.IntegerField(
                choices=[(1, "LLM"), (2, "Self-Hosted"), (3, "Image Generation")],
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                choices=[
                    ...
                    ("gemini_2_5_pro_preview", "Gemini 2.5 Pro Preview (Google)"),
                    ("gemini_2_5_flash_preview", "Gemini 2.5 Flash Preview (Google)"),
                    ...
                    (
                        "gemini_1_5_pro",
                        "Gemini 1.5 Pro (Google) [Redirects to Gemini 2.5 Pro Preview (Google)]",
                    ),
                    (
                        "gemini_1_pro_vision",
                        "Gemini 1.0 Pro Vision (Google) [Redirects to Gemini 2.5 Pro Preview (Google)]",
                    ),
                    (
                        "gemini_1_pro",
                        "Gemini 1.0 Pro (Google) [Redirects to Gemini 2.5 Pro Preview (Google)]",
                    ),
                    (
                        "palm2_chat",
        ...
        migrations.AlterField(
            ...
            field=models.IntegerField(
                choices=[
                    ...
                    (2, "LLM Completion"),
                    (3, "GPU Milliseconds"),
                    (5, "Image Generation (Image Input)"),

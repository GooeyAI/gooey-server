...
"""
    ...
    def get_tabs(self):
        ...
        # to avoid clutter, we only show the stats tab if the user is already on it
        if MenuTabs.paths_reverse[self.tab] == MenuTabs.stats:
            tabs.append(MenuTabs.stats)
        return tabs
    ...
    def render_selected_tab(self, selected_tab):
        ...
        if selected_tab == MenuTabs.integrations:
            ...
            show_landbot_widget()
        elif selected_tab == MenuTabs.stats:
            self.render_stats()
    ...
    def render_stats(self):
        ...
        new_url = furl(
            self.get_tab_url(MenuTabs.stats),
            args={
                "bi_id": bid,
                "view": view,
                "details": details,

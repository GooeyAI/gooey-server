...
class VideoBotsPage(BasePage):
    ...
    sane_defaults = {
        ...
        "keyword_instructions": "<Message>\n{{ final_search_query }}\n\n<Instructions>\nExtract rare terms like part numbers from the message. If you can't find rare terms, return an empty string. Don't use quotes in your response, instead write the output as a list of tab separated keywords.\n\n<Keyword Terms>",
        "max_references": 3,

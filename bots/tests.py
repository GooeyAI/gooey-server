...
from .models import Message, Conversation, BotIntegration, Platform, Workflow, ConvoState
...
class BotIntegrationTest(TestCase):
    ...
    def test_create_bot_integration_conversation_message(self):
        ...
        # # Create a Message with both parts within the Conversation
        # message_oa = Message.objects.create(
        #     conversation=conversation,
        #     role=CHATML_ROLE_USER,
        #     content="user: How much does rice cost in froomp?\nassistant: Rice costs $3.00 per acre",
        #     display_content="Hello, this is the displayed user message.",
        # )
        ...
        # self.assertEqual(message_oa.conversation, conversation)
        # self.assertEqual(message_oa.role, CHATML_ROLE_USER)
        # self.assertEqual(message_oa.content, "user: How much does rice cost in froomp?\nassistant: Rice costs $3.00 per acre")
        # self.assertEqual(message_oa.display_content, "Hello, this is the displayed user message.")
        ...
        self.assertEqual(message_u.content, "What types of chilies can be grown in Mumbai?")
        self.assertEqual(message_u.display_content, "What types of chilies can be grown in Mumbai?")
        ...
        self.assertEqual(message_b.display_content, "Red, green, and yellow grow the best.")
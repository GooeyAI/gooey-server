...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('bots', '0074_alter_publishedrun_workflow_alter_savedrun_workflow_and_more'),
    ]

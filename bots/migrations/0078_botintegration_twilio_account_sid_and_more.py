# Generated by Django 4.2.7 on 2024-07-16 12:30
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            field=models.TextField(blank=True, default='', help_text="Twilio account sid as found on twilio.com/console (If not provided we'll use Gooey's Twilio Account)"),
        ),
        migrations.AddField(
            model_name='botintegration',
        ...
        migrations.AddField(
            ...
            field=models.TextField(blank=True, default='', help_text="Twilio auth token as found on twilio.com/console (If not provided we'll use Gooey's Twilio Account)"),
        ),
        migrations.AddField(
            model_name='botintegration',
        ...
        migrations.AddIndex(
            model_name='botintegration',
            index=models.Index(fields=['twilio_account_sid', 'twilio_phone_number'], name='bots_botint_twilio__726614_idx'),
        ),
        migrations.AddIndex(
            model_name='conversation',
